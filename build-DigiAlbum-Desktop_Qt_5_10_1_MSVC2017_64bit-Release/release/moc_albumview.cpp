...
void AlbumView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (AlbumView::*_t)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AlbumView::clicked)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject AlbumView::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_AlbumView.data,
      qt_meta_data_AlbumView,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void AlbumView::clicked(int _t1)
{
